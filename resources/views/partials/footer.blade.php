        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-1">
                ...
                <p class="text-gray-400 text-sm mb-4">
                    Your trusted travel partner for unforgettable vacation experiences. Book with confidence and create lasting memories.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    ...
                    <li><a href="{{ route('packages.index') }}" class="hover:text-white transition-colors">Travel Packages</a></li>
                    <li><a href="{{ route('blog.index') }}" class="hover:text-white transition-colors">Travel Blog</a></li>
