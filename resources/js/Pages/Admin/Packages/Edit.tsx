...
export default function PackageEdit() {
  ...
  const [formData, setFormData] = useState({
    ...
    short_description: 'Experience the magic of Bali with this all-inclusive paradise trip',
    description: 'Discover the beauty of Bali with our carefully curated 8-day, 7-night adventure. From stunning temples to pristine beaches, this trip covers all the highlights of the Island of the Gods.',
    ...
    itinerary: 'Day 1: Arrival in Bali, welcome dinner\nDay 2: Ubud cultural tour\nDay 3: Temple hopping\nDay 4: Beach day at Nusa Dua\nDay 5: Mount Batur sunrise trek\nDay 6: Free day\nDay 7: Spa and relaxation\nDay 8: Departure',
    highlights: '- Sunrise at Mount Batur\n- Traditional Balinese dance\n- pristine beaches\n- Ancient temples\n- Luxury spa experience',
    terms_conditions: 'Free cancellation up to 14 days before departure. 50% refund for cancellations 7-13 days before. No refund for cancellations less than 7 days before departure.',
  });
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Edit Travel Package</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Itinerary & Highlights</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Itinerary</label>
                <textarea name="itinerary" value={formData.itinerary} onChange={handleChange} rows={6}
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg outline-none resize-none"
                  placeholder="Day-by-day schedule" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Highlights</label>
                <textarea name="highlights" value={formData.highlights} onChange={handleChange} rows={6}
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg outline-none resize-none"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <textarea name="terms_conditions" value={formData.terms_conditions} onChange={handleChange} rows={4}
              className="w-full px-4 py-2.5 border border-gray-200 rounded-lg outline-none resize-none"
