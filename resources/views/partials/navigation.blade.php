    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="{{ route('faq') }}" class="text-gray-700 hover:text-blue-600 font-medium {{ request()->routeIs('faq') ? 'text-blue-600' : '' }}">
                    FAQ
                </a>
        ...
        <div x-show="mobileMenu" class="md:hidden py-4 border-t" style="display: none;">
            <div class="flex flex-col gap-4">
                ...
                <a href="{{ route('faq') }}" class="text-gray-700 hover:text-blue-600 font-medium">FAQ</a>
